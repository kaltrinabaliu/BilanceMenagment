                ...
                <div class="box box-warning">
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                 <b>Bilance</b> <a class="pull-right"><?= $bilance ?></a> 
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="<?= ($active == "details")? "active" : "" ?> tab-pane" id="details">
                            <form action="<?php echo base_url() ?>profileUpdate" method="post" id="editProfile" role="form">
                                ...
                                <div class="box-body">
                                    ...
                                    <input type="button" class="btn btn-primary" id="sendBalanceBtn"value="Dergo bilancin" />

                                    
                                </div><!-- /.box-body -->

                                <!-- Modal -->
<div class="modal fade" id="sendBalanceModal" tabindex="-1" role="dialog" aria-labelledby="sendBalanceModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="sendBalanceModalLabel">Dërgo Bilancin</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <!-- Inputet për emrin, emailin dhe bilancin -->
        <form action="<?= base_url() ?>sendBalance" method="post">
                <div class="form-group">
                    <label for="recipientEmail">Recipient's Email:</label>
                    <input type="email" class="form-control" id="recipientEmail" name="recipientEmail" placeholder="Recipient's Email" required>
                </div>
                <div class="form-group">
                    <label for="balanceAmount">Amount to Send:</label>
                    <input type="text" class="form-control" id="balanceAmount" name="balanceAmount" placeholder="Amount to Send" required>
                </div>
                <button type="submit" class="btn btn-primary">Send Balance</button>
            </form>
      </div>
    </div>
  </div>
...
<script>
    $(document).ready(function () {
        $("#sendBalanceBtn").click(function () {
            $("#sendBalanceModal").modal("show");
        });

        $("#sendBalanceModal #sendBalanceBtn").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>sendBalance", 
                data: {
