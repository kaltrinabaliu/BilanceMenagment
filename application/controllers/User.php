    ...
    function addNewUser()
    {
        ...
        else
        {
            $this->load->library('form_validation');
             ...
             if($this->isAdmin() && $this->input->post('isAdmin') == SYSTEM_ADMIN)
        {
            $this->session->set_flashdata('error', 'Only super admin can add another admin.');
    ...
    function showBalance()
{
    ...
    $balance = $this->user_model->getUserBalance($userId);
...
/**
 * This function is used to send the balance to another user
 */
function sendBalance()
{
    ...
    $senderUserId = $this->vendorId;
    $senderBalance = $this->user_model->getUserBalance($senderUserId);

    if ($senderBalance >= $balanceAmount) {
        $this->user_model->sendBalance($recipientEmail, $balanceAmount);
        $this->user_model->updateUserBalance($senderUserId, $senderBalance - $balanceAmount);

        echo "Balance sent successfully!";
    } else {
